...
function _findInputWithValue(wrapper, value) {
  return Array.from(wrapper.querySelectorAll('input[name="fruit"]')).find(x => x.value === value)
}
...
describe('ReactCheckboxGroup', function() {
  ...
  it('Disables a box when `disabled` is used', function() {
    ...
    var disabledBoxes = ReactDOM.findDOMNode(component).querySelectorAll(
      'input[type="checkbox"][name="fruit"][disabled]'
    )
  ...
  it('Keeps the same boxes checked if controlled', function() {
    ...
    var fruits = ['watermelon', 'pineapple']
    var component = ReactDOM.render(
      <CheckboxGroup name="fruit" selectedValue={fruits}>
        <Checkbox value="kiwi" />
        <Checkbox value="pineapple" />
        <Checkbox value="watermelon" />
      </CheckboxGroup>,
  ...
  it('Checks the correct boxes when props change', function() {
    ...
    var fruits = ['watermelon', 'pineapple']
    var component = ReactDOM.render(
      <CheckboxGroup name="fruit" selectedValue={['watermelon']}>
        <Checkbox value="kiwi" />
        <Checkbox value="pineapple" />
        <Checkbox value="watermelon" />
      </CheckboxGroup>,
    ...
    var component = ReactDOM.render(
      <CheckboxGroup name="fruit" selectedValue={['watermelon', 'kiwi']}>
        <Checkbox value="kiwi" />
        <Checkbox value="pineapple" />
        <Checkbox value="watermelon" />
      </CheckboxGroup>,
  ...
  it('Calls `onChange` with the correct new value', function() {
    ...
    var component = renderIntoDocument(
      <CheckboxGroup name="fruit" selectedValue={fruits} onChange={onChange}>
        <Checkbox value="kiwi" />
        <Checkbox value="pineapple" />
        <Checkbox value="watermelon" />
      </CheckboxGroup>
